with open('05.txt') as f:
    seeds = f.readline()
    lines = f.readlines()
seeds = seeds.replace('seeds:', '').strip().split(' ')
...
all_maps = [seed_to_soil, soil_to_fertilizer, fertilizer_to_water, water_to_light, light_to_temperature, 
...
#         if source <= i and i < source + length:
